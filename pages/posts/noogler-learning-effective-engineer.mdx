...
export const meta = {
  title: '在 Google 的这半年：如何成为更高效的软件工程师',
  author: 'Linghao',
  date: '2019-05-12',
  lang: 'zh',
  description: '要成为一个高效的工程师，在理论和实践之间还是存在着不小的距离需要我们通过学习、试错和反思去跨越的。本文将结合我在 Google 参与的第一个项目来分享一些心得和教训。'
}
...
入职 Google 快半年，我深切地感受到：要成为一个高效的软件工程师，在理论和实践之间还是存在着不小的距离需要我们通过学习、试错和反思去跨越的。本文将结合我在 Google 参与的第一个项目来分享一些心得和教训。

---

## Background

在这个项目中，我的主要工作是修改和运行一个 C++ pipeline 来 backfill<sup>[1](#notes)</sup> 几年的用户数据。过程如下：
