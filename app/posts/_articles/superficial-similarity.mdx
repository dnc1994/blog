export const metadata = {
  ...
  description: 'We all know it pays to be aware of biases, but sometimes we just couldn\'t help being blind to it. On the danger of superficial similarity.',
  date: '2022.06.16',
  tags: ['Musings', 'Engineering Culture'],
}
