export const metadata = {
  ...
  canonical: true,
  image: 'https://r2.linghao.io/blog-assets/software-speciation-og.jpg',
}
...
Once this becomes the norm, software begins to "speciate". What follows are three consequences of this shift and a few predictions for where the evolutionary path leads.
...
*Generative AI Usage Disclosure: Refined by Gemini and ChatGPT.*
