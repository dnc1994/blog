export const metadata = {
  ...
  description: 'It\'s easy to be pessimistic about the world, but knowledge is infinite and creativity is unpredictable. Thoughts on rethinking pessimism.',
  date: '2022.07.13',
  tags: ['Musings', 'Philosophy', 'Personal Growth'],
}
