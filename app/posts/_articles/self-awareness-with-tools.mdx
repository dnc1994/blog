export const metadata = {
  ...
  description: 'Am I a douchebag if I can\'t sense my own anger without high-tech gadgets? On self-awareness and using tools to improve it.',
  date: '2022.07.26',
  tags: ['Musings', 'Productivity', 'Personal Growth'],
}
