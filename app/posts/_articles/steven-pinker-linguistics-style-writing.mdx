export const metadata = {
  title: 'Notes: Steven Pinker on Linguistics, Style and Writing',
  description: 'Notes on Steven Pinker\'s talk about linguistics, style and writing.',
  date: '2018.07.20',
  tags: ['Notes', 'Writing', 'Communication'],
}
