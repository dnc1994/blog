export const metadata = {
  ...
  canonical: true,
  image: 'https://r2.linghao.io/blog-assets/ai-memory-negative-space-og.jpg',
}
...
The pipeline uses a frontier model to dynamically generate a **Competency Checklist** for that specific Latent Spec. This is the benchmark of what a "complete" version of this journey looks like.

| User | Competency Checklist |
|---|---|
...
The pipeline uses a frontier model to look for gaps between the user's actual activities and the Competency Checklist.
