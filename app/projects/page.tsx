              ...
              <div className='min-w-0'>
                <div className='flex items-center gap-2.5'>
                  ...
                  <Link
                    ...
                    draggable={false}
                    className='font-medium text-[1.06rem] leading-6 text-rurikon-600 hover:text-rurikon-accent transition-colors underline decoration-rurikon-200 hover:decoration-rurikon-accent underline-offset-2'
                  >
                    {project.name}
                  </Link>
                </div>
